![java](https://img-blog.csdnimg.cn/c6d08df894c74b01bb11c531db8d9576.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQwNDkzOTQ0,size_16,color_FFFFFF,t_70)
## 什么是spring?
...
>核心容器（Core Container） 、
> AOP（Aspect Oriented Programming）和设备支持（Instrmentation） 、数据访问与集成（Data Access/Integeration） 、
>  Web、 
>  消息（Messaging） 、 
>  Test等 6 个模块中。 

**以下是 Spring 5 的模块结构图：**
![Spring](https://img-blog.csdnimg.cn/fc16f4560dbf47d89943db4f57652512.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQwNDkzOTQ0,size_16,color_FFFFFF,t_70)
...
![spring容器](https://img-blog.csdnimg.cn/75ab7b53b0974164ac35f0fd81156cbb.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQwNDkzOTQ0,size_16,color_FFFFFF,t_70)
...
![bean生命周期](https://img-blog.csdnimg.cn/a3c5ce628623401f815560fb8513a327.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQwNDkzOTQ0,size_16,color_FFFFFF,t_70)
...
支持声明式事务管理。和Spring各种数据访问抽象层很好得集成。
